...
# '<username>' isimli müşterinin sipariş toplamı '<10000>' liradır. (donguler)
...
kullaniciAdi = input('Kullanici adi gir : ')
siparisToplam = int(input('Siparis toplamini gir : '))
customers.append(kullaniciAdi)
order_totals.append(siparisToplam)
